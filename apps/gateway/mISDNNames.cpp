...
// namespace mISDN { //this is hack to cover definition of dprint which is
// defined in mISDN and sems core
extern "C" {
...
const char* mISDNNames::isdn_prim[4] = {" REQUEST", " CONFIRM", " INDICATION",
                                        " RESPONSE"};
const char* mISDNNames::IE_Names[37] = {"bearer_capability",
                                        "cause",
                                        "call_id",
                                        "call_state",
                                        "channel_id",
