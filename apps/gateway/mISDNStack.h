...
#include <pthread.h>
namespace mISDN
{ // this is hack to cover definition of dprint which is defined in mISDN and
  // sems core
extern "C" {
...
{
  mISDN::net_stack_t
                   nst; /* MUST be the first entry, so &nst equals &mISDNlist */
  mISDN::manager_t mgr;
...
class mISDNStack : public AmThread
{
 ...
 public:
  ...
  /* here are some maps and functions to lookup CallReference and B-channel
