...
{
 public:
  GWSession(const string& auth_realm, const string& auth_user,
  ...
  // virtual void onSendRequest(const string& method, const string&
  // content_type, const string& body, string& hdrs, int flags, unsigned int
  // cseq);  virtual void onSendReply(const AmSipRequest& req, unsigned int
  // code,const string& reason,const string& content_type, const string&
  // body,string& hdrs,int flags)
  void on_stop();
