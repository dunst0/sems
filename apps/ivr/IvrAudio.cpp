...
static PyObject* IvrAudioFile_new(PyTypeObject* type, PyObject* args,
                                  PyObject* kwds)
{
...
{
  int rew_time;
  if (!PyArg_ParseTuple(args, "|i", &rew_time)) return NULL;
...
static PyObject* IvrAudioFile_tts(PyObject* cls, PyObject* args)
{
  ...
  if (tts_file == NULL) {
    ...
    PyErr_SetString(PyExc_RuntimeError,
                    "could not create new IvrAudioFile object");
    return NULL;
  }
...
static PyGetSetDef IvrAudioFile_getseters[] = {
    {(char*) "loop", (getter) IvrAudioFile_getloop,
     (setter) IvrAudioFile_setloop, (char*) "repeat mode", NULL},
    {NULL} /* Sentinel */
};
