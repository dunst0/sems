...
typedef struct
{
  PyObject_HEAD AmSipReply* p_req;
} IvrSipReply;

// Constructor
static PyObject* IvrSipReply_new(PyTypeObject* type, PyObject* args,
                                 PyObject* kwds)
{
...
static void IvrSipReply_dealloc(IvrSipReply* self)
{
  delete self->p_req;
...
#define def_IvrSipReply_GETTER(getter_name, attr)                              \
  static PyObject* getter_name(IvrSipReply* self, void* closure)               \
  {                                                                            \
...
def_IvrSipReply_GETTER(IvrSipReply_getreason, reason)
    ...
    static PyObject* IvrSipReply_getcseq(IvrSipReply* self, void* closure)
{
  return PyInt_FromLong(self->p_req->cseq);
}

static PyObject* IvrSipReply_getcode(IvrSipReply* self, void* closure)
{
...
static PyGetSetDef IvrSipReply_getset[] = {
    ...
    {(char*) "reason", (getter) IvrSipReply_getreason, NULL, (char*) "reason",
     NULL},
    {(char*) "contact", (getter) IvrSipReply_getcontact, NULL,
     (char*) "contact", NULL},
