...
// Constructor
static PyObject* IvrDialogBase_new(PyTypeObject* type, PyObject* args,
                                   PyObject* kwds)
{
...
static void IvrDialogBase_dealloc(IvrDialogBase* self)
{
...
static PyObject* IvrDialogBase_bye(IvrDialogBase* self, PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args, "|s", &hdrs)) return NULL;
...
static PyObject* IvrDialogBase_enqueue(IvrDialogBase* self, PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args, "OO", &o_play, &o_rec)) return NULL;
...
static PyObject* IvrDialogBase_enableReceiving(IvrDialogBase* self,
                                               PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_disableReceiving(IvrDialogBase* self,
                                                PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_enableDTMFReceiving(IvrDialogBase* self,
                                                   PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_disableDTMFReceiving(IvrDialogBase* self,
                                                    PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_enableDTMFDetection(IvrDialogBase* self,
                                                   PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_disableDTMFDetection(IvrDialogBase* self,
                                                    PyObject*      args)
{
  assert(self->p_dlg);
...
// B2B methods
static PyObject* IvrDialogBase_b2b_connectCallee(IvrDialogBase* self,
                                                 PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_b2b_set_relayonly(IvrDialogBase* self,
                                                 PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_b2b_set_norelayonly(IvrDialogBase* self,
                                                   PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_b2b_terminate_leg(IvrDialogBase* self,
                                                 PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_b2b_terminate_other_leg(IvrDialogBase* self,
                                                       PyObject*      args)
{
  assert(self->p_dlg);
...
static PyObject* IvrDialogBase_setTimer(IvrDialogBase* self, PyObject* args)
{
  ...
  int id = 0, interval = 0;
  if (!PyArg_ParseTuple(args, "ii", &id, &interval)) return NULL;
...
static PyObject* IvrDialogBase_getinvite_req(IvrDialogBase* self, void* closure)
{
  Py_INCREF(self->invite_req);
  return self->invite_req;
}

static PyObject* IvrDialogBase_getdialog(IvrDialogBase* self, void* closure)
{
  Py_INCREF(self->dialog);
  return self->dialog;
}

static PyObject* IvrDialogBase_redirect(IvrDialogBase* self, PyObject* args)
{
  assert(self->p_dlg);

  char* refer_to = 0;
  if (!PyArg_ParseTuple(args, "s", &refer_to)) return NULL;
...
static PyObject* IvrDialogBase_refer(IvrDialogBase* self, PyObject* args)
{
  assert(self->p_dlg);

  char* refer_to = 0;
  int   expires;
  if (!PyArg_ParseTuple(args, "si", &refer_to, &expires)) return NULL;
...
static PyObject* IvrDialogBase_getAppParam(IvrDialogBase* self, PyObject* args)
{
  const char* param_name;
  if (!PyArg_ParseTuple(args, "s", &param_name)) return NULL;
...
static PyMethodDef IvrDialogBase_methods[] = {
    ...
    //     },
    //     {"onEmptyQueue", (PyCFunction)IvrDialogBase_onEmptyQueue,
    //     METH_NOARGS,
    ...
    {"stopSession", (PyCFunction) IvrDialogBase_stopSession, METH_NOARGS,
     "Stop the session"},
    {"bye", (PyCFunction) IvrDialogBase_bye, METH_VARARGS, "Send a BYE"},
    ...
    {"enableReceiving", (PyCFunction) IvrDialogBase_enableReceiving,
     METH_NOARGS, "enable receiving of RTP packets"},
    {"disableReceiving", (PyCFunction) IvrDialogBase_disableReceiving,
     METH_NOARGS, "disable receiving of RTP packets"},
    {"enableDTMFReceiving", (PyCFunction) IvrDialogBase_enableDTMFReceiving,
     METH_NOARGS,
     "enable receiving of RFC-2833 DTMF packets even if RTP receiving is "
     "disabled"},
    {"disableDTMFReceiving", (PyCFunction) IvrDialogBase_disableDTMFReceiving,
     METH_NOARGS,
     "disable receiving of RFC-2833 DTMF packets when RTP receiving is "
     "disabled"},
    {"connectMedia", (PyCFunction) IvrDialogBase_add_mediaprocessor,
     METH_NOARGS, "enable the processing of audio and RTP"},
    {"disconnectMedia", (PyCFunction) IvrDialogBase_remove_mediaprocessor,
     METH_NOARGS, "disable the processing of audio and RTP"},
    // DTMF
    {"enableDTMFDetection", (PyCFunction) IvrDialogBase_enableDTMFDetection,
     METH_NOARGS, "enable the dtmf detection"},
    {"disableDTMFDetection", (PyCFunction) IvrDialogBase_disableDTMFDetection,
     METH_NOARGS, "disable the dtmf detection"},
    // B2B
    {"connectCallee", (PyCFunction) IvrDialogBase_b2b_connectCallee,
     METH_VARARGS,
    ...
    {"terminateLeg", (PyCFunction) IvrDialogBase_b2b_terminate_leg,
     METH_VARARGS, "Terminate our leg and forget the other"},
    {"terminateOtherLeg", (PyCFunction) IvrDialogBase_b2b_terminate_other_leg,
     METH_VARARGS, "Terminate the other leg and forget it"},
    {"setRelayonly", (PyCFunction) IvrDialogBase_b2b_set_relayonly, METH_NOARGS,
     "sip requests will be relayed, and not processed"},
    {"setNoRelayonly", (PyCFunction) IvrDialogBase_b2b_set_norelayonly,
     METH_NOARGS, "sip requests will be processed"},
    // Timers
...
static PyGetSetDef IvrDialogBase_getset[] = {
    {(char*) "dialog", (getter) IvrDialogBase_getdialog, NULL,
     (char*) "the dialog property", NULL},
    {(char*) "invite_req", (getter) IvrDialogBase_getinvite_req, NULL,
     (char*) "the initial invite request", NULL},
    {NULL} /* Sentinel */
};
