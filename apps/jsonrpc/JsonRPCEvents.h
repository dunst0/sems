...
struct JsonRpcResponseEvent : public JsonRpcEvent
{
  ...
  JsonRpcResponseEvent(bool is_error, string id, const AmArg& data,
                       const AmArg& udata)
...
struct JsonServerSendMessageEvent : public JsonServerEvent
{
  ...
  JsonServerSendMessageEvent(const string& connection_id, bool is_reply,
                             const string& method, const string& id,
                             const AmArg& params, const AmArg& udata = AmArg(),
