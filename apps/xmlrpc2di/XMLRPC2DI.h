...
#define DEF_XMLRPCSERVERMETHOD(cls_name, func_name)                            \
  class cls_name : public XmlRpcServerMethod                                   \
  {                                                                            \
   public:                                                                     \
...
DEF_XMLRPCSERVERMETHOD(XMLRPC2DIServerSetShutdownmodeMethod,
                       "set_shutdownmode");
DEF_XMLRPCSERVERMETHOD(XMLRPC2DIServerGetShutdownmodeMethod,
                       "get_shutdownmode");
...
class XMLRPC2DIServerDIMethod : public XmlRpcServerMethod
{
 public:
