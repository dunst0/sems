    ...
    , public DSMSession
{
 ...
 public:
  ...
  void initUAC(SBCCallProfile& profile, SimpleRelayDialog* relay,
               const AmSipRequest& req);
  void initUAS(SBCCallProfile& profile, SimpleRelayDialog* relay,
               const AmSipRequest& req);
  void finalize(SBCCallProfile& profile, SimpleRelayDialog* relay);
  void onSipRequest(SBCCallProfile& profile, SimpleRelayDialog* relay,
                    const AmSipRequest& req);
  void onSipReply(SBCCallProfile& profile, SimpleRelayDialog* relay,
                  const AmSipRequest& req, const AmSipReply& reply,
                  AmBasicSipDialog::Status old_dlg_status);
  void onB2BRequest(SBCCallProfile& profile, SimpleRelayDialog* relay,
                    const AmSipRequest& req);
  void onB2BReply(SBCCallProfile& profile, SimpleRelayDialog* relay,
  ...
  /** B2BUA functions */
  void B2BconnectCallee(const string& remote_party, const string& remote_uri,
