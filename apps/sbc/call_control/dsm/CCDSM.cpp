...
#define GET_DSM_INSTANCE                                                       \
  ...
  if (NULL == h) return StopProcessing;
...
CCChainProcessing
CCDSMModule::onInitialInvite(SBCCallLeg*                 call,
...
void CCDSMModule::onStateChange(SBCCallLeg*                       call,
...
CCChainProcessing CCDSMModule::onBLegRefused(SBCCallLeg*       call,
...
CCChainProcessing CCDSMModule::onInDialogRequest(SBCCallLeg*         call,
...
CCChainProcessing CCDSMModule::onInDialogReply(SBCCallLeg*       call,
                                               const AmSipReply& reply)
{
...
bool CCDSMModule::init(SBCCallProfile& profile, SimpleRelayDialog* relay,
                       void*& user_data)
{
...
void CCDSMModule::onSipReply(const AmSipRequest& req, const AmSipReply& reply,
