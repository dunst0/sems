...

{
 ...
 public:
  ...
  /* void onStateChange(SBCCallLeg *call, const CallLeg::StatusChangeCause
   * &cause); */
  /* CCChainProcessing onInDialogRequest(SBCCallLeg *call, const AmSipRequest
   * &req); */
  /* CCChainProcessing onInDialogReply(SBCCallLeg *call, const AmSipReply
   * &reply); */
  ...
  /* //    --- simple relay */
  /* bool init(SBCCallProfile &profile, SimpleRelayDialog *relay, void
   * *&user_data); */
