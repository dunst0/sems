...
const iana_rtp_payload IANA_RTP_PAYLOADS[IANA_RTP_PAYLOADS_SIZE] = {
    ...
    {"PCMU", true, 8000, 1}, // 0         PCMU            A
                             // 8000             1                 [RFC3551]
    {"", true, 0, 0},        // 1         Reserved
    {"", true, 0, 0},        // 2         Reserved
    {"GSM", true, 8000, 1}, // 3         GSM             A                  8000
                            // 1                 [RFC3551]
    {"G723", true, 8000, 1},  // 4         G723            A
                              // 8000             1 [Kumar][RFC3551]
    {"DVI4", true, 8000, 1},  // 5         DVI4            A
                              // 8000             1                 [RFC3551]
    {"DVI4", true, 16000, 1}, // 6         DVI4            A
                              // 16000            1                 [RFC3551]
    {"LPC", true, 8000, 1}, // 7         LPC             A                  8000
                            // 1                 [RFC3551]
    {"PCMA", true, 8000, 1},  // 8         PCMA            A
                              // 8000             1                 [RFC3551]
    {"G722", true, 8000, 1},  // 9         G722            A
                              // 8000             1                 [RFC3551]
    {"L16", true, 44100, 2},  // 10        L16             A
                              // 44100            2                 [RFC3551]
    {"L16", true, 44100, 1},  // 11        L16             A
                              // 44100            1                 [RFC3551]
    {"QCELP", true, 8000, 1}, // 12        QCELP           A
                              // 8000             1                 [RFC3551]
    {"CN", true, 8000, 1}, // 13        CN              A                  8000
                           // 1                 [RFC3389]
    {"MPA", true, 90000, 0},   // 14        MPA             A
                               // 90000 [RFC3551][RFC2250]
    {"G728", true, 8000, 1},   // 15        G728            A
                               // 8000             1                 [RFC3551]
    {"DVI4", true, 11025, 1},  // 16        DVI4            A
                               // 11025            1                 [DiPol]
    {"DVI4", true, 22050, 1},  // 17        DVI4            A
                               // 22050            1                 [DiPol]
    {"G729", true, 8000, 1},   // 18        G729            A
                               // 8000             1                 [RFC3551]
