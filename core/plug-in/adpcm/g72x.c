...
static short int power2[15] = {1,     2,     4,      8,      0x10,
 ...
 */
static int quan(int val, short int* table, int size)
{
  int i;
...
{
  short int anmag, anexp, anmant;
  short int wanexp, /*wanmag,*/ wanmant;
  short int retval;
...
{
  short int dqm;  /* Magnitude of 'd' */
  short int exp;  /* Integer part of base 2 log of 'd' */
  short int mant; /* Fractional part of base 2 log */
  short int dl;   /* Log of magnitude of 'd' */
  short int dln;  /* Step size scale factor normalized log */
  int       i;
...
int reconstruct(int sign, /* 0 for non-negative value */
                ...
                int y)    /* Step size multiplier */
{
  short int dql; /* Log of 'dq' magnitude */
  short int dex; /* Integer part of log */
  short int dqt;
  short int dq; /* Reconstructed difference signal sample */
