 ...
 */
static short int _dqlntab[4] = {116, 365, 365, 116};
 ...
 */
static short int _witab[4] = {-704, 14048, 14048, -704};
...
/* Comes from FUNCTF */
static short int _fitab[4] = {0, 0xE00, 0xE00, 0};

/* Comes from quantizer decision level tables (Table 7/G.726)
 */
static short int qtab_723_16[1] = {261};
 ...
 */
int g723_16_encoder(int sl, int in_coding, struct g72x_state* state_ptr)
{
  ...
  switch (in_coding) { /* linearize input sample to 14-bit PCM */
    case AUDIO_ENCODING_ALAW: sl = alaw2linear(sl) >> 2; break;
    case AUDIO_ENCODING_ULAW: sl = ulaw2linear(sl) >> 2; break;
 ...
 */
int g723_16_decoder(int i, int out_coding, struct g72x_state* state_ptr)
{
