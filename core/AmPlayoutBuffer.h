...
class AmPlayoutBuffer
{
 ...
 protected:
  ...
  virtual void write_buffer(u_int32_t ref_ts, u_int32_t ts, int16_t* buf,
                            u_int32_t len);
  virtual void direct_write_buffer(unsigned int ts, ShortSample* buf,
                                   unsigned int len);
...
class AmAdaptivePlayout : public AmPlayoutBuffer
{
 ...
 public:
  ...
  void write_buffer(u_int32_t ref_ts, u_int32_t ts, int16_t* buf,
                    u_int32_t len);
...
class AmJbPlayout : public AmPlayoutBuffer
{
 ...
 public:
  ...
  u_int32_t read(u_int32_t ts, int16_t* buf, u_int32_t len);
  void write(u_int32_t ref_ts, u_int32_t rtp_ts, int16_t* buf, u_int32_t len,
             bool begin_talk);
};
