...
FCTMF_SUITE_BGN(test_uriparser)
{
  ...
  FCT_TEST_BGN(uriparser_params_dname4)
  {
    AmUriParser p;
    size_t      end;
    fct_chk(p.parse_contact(
        "\"Mr. Watson\" <mailto:watson@bell-telephone.com> ;q=0.1", 0, end));
  ...
  FCT_TEST_BGN(uriparser_headers)
  {
    ...
    fct_chk(p.parse_contact("\"Mr. Watson\" "
                            "<mailto:watson@bell-telephone.com?Replaces:%"
                            "20lkancskjd%3Bto-tag=3123141ab%3Bfrom-tag="
                            "kjhkjcsd> ;q=0.1",
                            0, end));
    fct_chk(p.display_name == "Mr. Watson");
    fct_chk(p.uri_user == "watson");
    fct_chk(p.uri_host == "bell-telephone.com");
    fct_chk(p.uri_headers
            == "Replaces:\%20lkancskjd%3Bto-tag=3123141ab%3Bfrom-tag=kjhkjcsd");
  }
  FCT_TEST_END();
  ...
  {
    AmUriParser p;
    string      orig_str = "\"Mr. Watson\" "
                      "<sip:watson@bell-telephone.com?Replaces:%20lkancskjd%"
                      "3Bto-tag=3123141ab%3Bfrom-tag=kjhkjcsd>;q=0.1";
  ...
  FCT_TEST_BGN(uriparser_url_escape)
  {
    ...
    string dst =
        "Replaces%3A%20CSADFSD%3Bfrom-tag%3D31241231abc%3Bto-tag%3D235123";
  ...
  FCT_TEST_BGN(uriparser_params_dname6)
  {
    AmUriParser p;
    size_t      end;
    fct_chk(p.parse_contact("<sip:alice@atlanta.com>;+g.3gpp.icsi-ref=\"urn%"
                            "3Aurn-7%3A3gpp-service.ims.icsi.mmtel\";video;"
                            "mobility=\"mobile\"",
                            0, end));
