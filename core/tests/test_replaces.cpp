...
FCTMF_SUITE_BGN(test_replaces)
{
  ...
  FCT_TEST_BGN(replaces_fixup_refer)
  {
    ...
    string       orig_str = "Refer-To: \"Mr. Watson\" "
                      "<sip:watson@bell-telephone.com?Replaces=C%3Bto-tag%3DCt%"
                      "3Bfrom-tag%3DCf>;q=0.1";
    string new_str = "Refer-To: \"Mr. Watson\" "
                     "<sip:watson@bell-telephone.com?Replaces=C2%3Bfrom-tag%"
                     "3DC2f%3Bto-tag%3DC2t>;q=0.1\r\n";
  ...
  FCT_TEST_BGN(replaces_fixup_refer2)
  {
    ...
    AmSipRequest r;
    string       orig_str = "Refer-To: \"Mr. Watson\" "
                      "<sip:watson@bell-telephone.com?Require=replaces;"
                      "Replaces=C%3Bto-tag%3DCt%3Bfrom-tag%3DCf>;q=0.1\r\n";
    string new_str = "Refer-To: \"Mr. Watson\" "
                     "<sip:watson@bell-telephone.com?Require=replaces;Replaces="
                     "C2%3Bfrom-tag%3DC2f%3Bto-tag%3DC2t>;q=0.1\r\n";
  ...
  FCT_TEST_BGN(replaces_fixup_refer3)
  {
    ...
    string       orig_str = "Refer-To: \"Mr. Watson\" "
                      "<sip:watson@bell-telephone.com?Require=replaces;"
                      "Replaces=C%3Bto-tag%3DCt%3Bfrom-tag%3DCf;Bla=Blub>;q=0."
                      "1\r\n";
    string new_str = "Refer-To: \"Mr. Watson\" "
                     "<sip:watson@bell-telephone.com?Require=replaces;Replaces="
                     "C2%3Bfrom-tag%3DC2f%3Bto-tag%3DC2t;Bla=Blub>;q=0.1\r\n";
