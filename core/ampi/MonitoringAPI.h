...
#define _MONITORING_DECLARE_INTERFACE(MOD) AmDynInvoke* MOD::monitoring_di = 0;

#define _MONITORING_DEFINE_INTERFACE static AmDynInvoke* monitoring_di;

#define MONITORING_GLOBAL_INTERFACE AmSessionContainer::monitoring_di
