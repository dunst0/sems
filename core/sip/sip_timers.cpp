...
unsigned int sip_timers[__STIMER_MAX] = {
    ...
    DEFAULT_A_TIMER, DEFAULT_B_TIMER, DEFAULT_D_TIMER,

    // non-INVITE client transaction
    DEFAULT_E_TIMER, DEFAULT_F_TIMER, DEFAULT_K_TIMER,

    // INVITE server transaction
    DEFAULT_G_TIMER, DEFAULT_H_TIMER, DEFAULT_I_TIMER,
...
const char* _timer_name_lookup[] = {"A", "B", "D", "E", "F", "K", "G",
                                    "H", "I", "J", "L", "M", "C", "BL"};
