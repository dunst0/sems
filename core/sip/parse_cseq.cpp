...
int parse_cseq(sip_cseq* cseq, const char* beg, int len)
{
    ...
    switch (st) {
      ...
      case C_METHOD:
        switch (*c) {
          ...
          case SP:
          case HTAB: cseq->method_str.set(beg, c - beg); return 0;
        }
        break;
      ...
      case ST_CRLF:
        switch (saved_st) {
          case C_NUM:
            ...
            break;
          case C_METHOD: cseq->method_str.set(beg, c - beg); return 0;
        }
        st = saved_st;
        break;
    }
  ...
  if (parse_method(&cseq->method, cseq->method_str.s, cseq->method_str.len)
      < 0) {
